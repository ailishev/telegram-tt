...
const CSP = `
  default-src 'self';
  connect-src 'self' wss://*.web.telegram.org https://vercel.live wss://ws-us3.pusher.com blob: http: https: ${APP_ENV === 'development' ? 'wss: ipc:' : ''};
  script-src 'self' 'wasm-unsafe-eval' https://t.me/_websync_ https://telegram.me/_websync_ https://vercel.live;
